          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <img 
                ...
                alt="Rooch" 
              />
              <span className="ml-2 text-xl font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">
                Rooch DEX
              </span>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <Chip
                label="Testnet"
                size="small"
                className="font-medium !bg-gradient-to-r from-orange-500 to-orange-600 !text-white shadow-sm"
              />
              ...
              <div className="relative">
                ...
                >
                  {currentWallet.status === "connected"
                    ? shortAddress(currentAddress?.genRoochAddress().toStr(), 6, 4)
                    : "Connect Wallet"}
                </Button>
